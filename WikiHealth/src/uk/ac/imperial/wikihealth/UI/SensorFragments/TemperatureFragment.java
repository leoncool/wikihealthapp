...
public class TemperatureFragment extends Fragment implements SensorEventListener {
    ...
    public static Bundle createBundle( String title ) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		    ...
		    mAcc = mSensorManager.getDefaultSensor(Sensor.TYPE_TEMPERATURE);
			...
			mView= inflater.inflate(R.layout.general_sensor_layout, container, false);
			 ...
			 valuez=(TextView)mView.findViewById(R.id.valuez);
				...
				mDescription.setText(getResources().getText(R.string.ambient_temperature_description));
			
			 
			 ((TextView)mView.findViewById(R.id.title)).setText("Ambient temperature (Celsius)");

				mCheck=(CheckBox)mView.findViewById(R.id.sensorCheck);
				
				final Contract c=new TemperatureContract();
				...
				mCheck.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						if(mCheck.isChecked()){
							TemperatureContract.sMonitor=true;
							PreferenceUtils.updateMonitoringPreference(mView.getContext(),c, true);

						}
						else{
							TemperatureContract.sMonitor=false;
				 ...
				 mSave.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							if(mPeriodText.getText()==null || mPeriodText.getText().toString().equals("")||  (mPeriodText.getText().toString().length()>6) || Integer.parseInt(mPeriodText.getText().toString())<1000 ){
								...
								TemperatureContract.sPeriod=Integer.parseInt(mPeriodText.getText().toString());
