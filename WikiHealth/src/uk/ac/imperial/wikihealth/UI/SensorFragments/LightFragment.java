...
public class LightFragment extends Fragment implements SensorEventListener {
    ...
    public static Bundle createBundle( String title ) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		    ...
		    mAcc = mSensorManager.getDefaultSensor(Sensor.TYPE_LIGHT);
			...
			mDescription.setText(getResources().getText(R.string.light_description));
			 ...
			 ((TextView)mView.findViewById(R.id.title)).setText("Ambient light level");
			 
				mCheck=(CheckBox)mView.findViewById(R.id.sensorCheck);
				
				final Contract c=new LightContract();
