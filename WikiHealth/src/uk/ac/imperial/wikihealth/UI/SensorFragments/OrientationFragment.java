...
public class OrientationFragment extends Fragment implements SensorEventListener {
    ...
    public static Bundle createBundle( String title ) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		    ...
		    mAcc = mSensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION);
			...
			mView= inflater.inflate(R.layout.general_sensor_layout, container, false);
			 ...
			 valuez=(TextView)mView.findViewById(R.id.valuez);
				...
				mDescription.setText(getResources().getText(R.string.orientation_description));
			
			 ((TextView)mView.findViewById(R.id.title)).setText("Angles in degrees");
			 ...
			 ((TextView)mView.findViewById(R.id.labelz)).setText("Z-axis");
				...
				final Contract c=new OrientationContract();
				...
				mCheck.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						if(mCheck.isChecked()){
							OrientationContract.sMonitor=true;
							PreferenceUtils.updateMonitoringPreference(mView.getContext(),c, true);

						}
						else{
							OrientationContract.sMonitor=false;
				 ...
				 mSave.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							if(mPeriodText.getText()==null || mPeriodText.getText().toString().equals("")||  (mPeriodText.getText().toString().length()>6) || Integer.parseInt(mPeriodText.getText().toString())<1000 ){
								...
								OrientationContract.sPeriod=Integer.parseInt(mPeriodText.getText().toString());
