...
public class GyroscopeFragment extends Fragment implements SensorEventListener {
    ...
    public static Bundle createBundle( String title ) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		    ...
		    mAcc = mSensorManager.getDefaultSensor(Sensor.TYPE_GYROSCOPE);
			mSensorManager.registerListener(this,mAcc, 100000000);
			mView= inflater.inflate(R.layout.general_sensor_layout, container, false);
			 ...
			 valuez=(TextView)mView.findViewById(R.id.valuez);
				...
				mDescription.setText(getResources().getText(R.string.gyroscope_description));
			 
			 ((TextView)mView.findViewById(R.id.title)).setText("Angular Speed");
			 ...
			 ((TextView)mView.findViewById(R.id.labelz)).setText("Z-axis");	
				...
				final Contract c=new GyroscopeContract();
				 ...
				 mSave.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							if(mPeriodText.getText()==null || mPeriodText.getText().toString().equals("")||  (mPeriodText.getText().toString().length()>6) || Integer.parseInt(mPeriodText.getText().toString())<1000 ){
								...
								GyroscopeContract.sPeriod=Integer.parseInt(mPeriodText.getText().toString());
