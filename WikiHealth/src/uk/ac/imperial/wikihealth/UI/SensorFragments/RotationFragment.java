...
public class RotationFragment extends Fragment implements SensorEventListener {
    ...
    public static Bundle createBundle( String title ) {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		    ...
		    mAcc = mSensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR);
			...
			mView= inflater.inflate(R.layout.general_sensor_layout, container, false);
			 ...
			 valuez=(TextView)mView.findViewById(R.id.valuez);
				...
				mDescription.setText(getResources().getText(R.string.rotation_description));
			
			 ((TextView)mView.findViewById(R.id.title)).setText("Orientation Vector");
			 ...
			 ((TextView)mView.findViewById(R.id.labelz)).setText("Z-axis");
				...
				final Contract c=new RotationContract();
				 ...
				 mSave.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							if(mPeriodText.getText()==null || mPeriodText.getText().toString().equals("")||  (mPeriodText.getText().toString().length()>6) || Integer.parseInt(mPeriodText.getText().toString())<1000 ){
								...
								RotationContract.sPeriod=Integer.parseInt(mPeriodText.getText().toString());
